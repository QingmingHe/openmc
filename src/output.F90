...
!===============================================================================
  ...
  subroutine write_tallies()
    ...
    score_names(abs(SCORE_CURRENT_IN))           = "Current in"
    score_names(abs(SCORE_CURRENT_OUT))          = "Current out"
    score_names(abs(SCORE_CURRENT_IN_LEGENDRE))  = "Current In Legendre"
    score_names(abs(SCORE_CURRENT_OUT_LEGENDRE)) = "Current Out Legendre"
